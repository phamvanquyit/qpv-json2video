...
The [`examples/`](https://github.com/phamvanquyit/qpv-json2video/tree/main/examples) directory contains ready-to-use JSON configs demonstrating every feature:
...
📖 **Full documentation:** 👉 [**docs/**](https://github.com/phamvanquyit/qpv-json2video/tree/main/docs)

| Category            | Docs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Getting Started** | [Installation, API, Quick Start](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/getting-started.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Schema**          | [VideoConfig, Track, Scene](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/schema.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Elements**        | [Text](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/elements/text.md) · [Image](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/elements/image.md) · [Video](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/elements/video.md) · [Shape](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/elements/shape.md) · [Caption](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/elements/caption.md) · [SVG](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/elements/svg.md) · [Waveform](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/elements/waveform.md)                                                                                                                          |
| **Effects**         | [Shadow](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/effects/shadow.md) · [Filters](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/effects/filters.md) · [Blend Modes](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/effects/blend-modes.md) · [Gradient](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/effects/gradient.md) · [Glow](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/effects/glow.md) · [Vignette](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/effects/vignette.md) · [Color Overlay](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/effects/color-overlay.md) · [Mask](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/effects/mask.md) |
| **Motion**          | [Animations](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/animations.md) · [Transitions](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/transitions.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Audio**           | [Audio mixing, fade, loop, trim](https://github.com/phamvanquyit/qpv-json2video/blob/main/docs/audio.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
